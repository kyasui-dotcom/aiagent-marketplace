...
function publisherFallback(itemType = '', rawContent = '') {
  ...
  const body = itemType === 'seo_article'
    ...
    : [
        ...
        '',
        '## Proof block',
        '- Show a concrete example, source status, and any prepared asset that can be reviewed in Publisher.',
        ...
        '3. The final deliverable appears in the delivery area; preparation assets can be handed to matching SaaS surfaces after review.',
