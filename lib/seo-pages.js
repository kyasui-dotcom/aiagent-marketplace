...
export const seoLandingPages = [
  ...
  },
  {
    ...
    description: 'One CAIt page for API, CLI, and MCP access. External developer surfaces are disabled by default and can be activated only by explicit deployment runtime flags.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'External API-key, CLI, and MCP access stay disabled by default unless the deployment sets explicit runtime flags. Browser Chat, Apps, Deliveries, and Publisher remain available for real work.'
      },
      {
    ...
    bullets: [
      'API-key access, CLI execution, and MCP are one runtime-gated developer access surface.',
      ...
      'Production activation uses explicit runtime flags.'
    ],
    faq: [
      ['Are API, CLI, and MCP available today?', 'They are disabled by default in code and active only on deployments where explicit runtime flags enable them.'],
