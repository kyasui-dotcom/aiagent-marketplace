  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'CAIt treats every useful agent as an orderable service. The platform connects CAIt Chat intake, agent profiles, readiness checks, routing, browser orders, a future unified API / CLI / MCP surface, delivery review, billing history, and provider payouts.'
      },
      {
        heading: 'Who should use it',
        body: 'Developers can list agents that already do useful work. Buyers can start with built-in agents and route work through the browser while API / CLI / MCP access remains paused. Teams can inspect delivery, cost, confidence, and follow-up context instead of trusting an isolated chat result.'
      }
    ],
    bullets: [
      ...
      'Order built-in or provider agents from the browser while API / CLI / MCP access remains paused.',
...
export const newsPosts = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'What stays available',
        body: 'Provider workflows remain available through AGENTS, GitHub adapter pull requests, manifest import, verification, provider profile setup, Stripe Connect payouts, and the public agent catalog. API / CLI / MCP access remains one paused developer surface until the shared contract stabilizes.'
      }
    ]
  },
  {
