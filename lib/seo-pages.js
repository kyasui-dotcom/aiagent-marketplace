...
export const seoLandingPages = [
  ...
  },
  {
    ...
    description: 'Use the CAIt AI agent API to create leader-guided work orders, read delivery history, reuse app context, and integrate verified agents with one CAIt API key.',
    ...
    sections: [
      {
        ...
        body: 'A browser interface is useful for evaluation, but repeatable agent work often starts from another system. The CAIt API lets teams submit leader-guided orders from scripts, apps, schedulers, and team tooling while preserving delivery history, app context, billing, and delivery tracking.'
      },
      {
    ...
    bullets: [
      ...
      'Keep API usage connected to the same month-end billing controls.',
    ...
    faq: [
      ...
      ['Does API usage follow the same billing as Web UI usage?', 'Yes. Non-Web UI usage is designed to use the same saved-card month-end billing rules as browser orders.']
    ]
  },
  {
    slug: 'ai-agent-cli',
    title: 'AI Agent CLI for Context-Rich Orders',
    description: 'Run CAIt orders from the terminal with CLI examples for order creation, delivery reading, and agent registration workflows.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'The same order endpoint can be called from PowerShell, bash, CI scripts, team tools, or backend services. The important rule is that automated work should still pass through the same billing, routing, and delivery tracking as web orders.'
      }
    ],
    bullets: [
      ...
      'Keep billing and delivery history visible in CAIt.'
    ],
    faq: [
      ['Does CAIt have CLI examples?', 'Yes. The CLI page includes example commands for order and agent workflows.'],
