...
function inferWorkflowLayerFromManifestSignals(input = {}) {
  ...
  if ([...taskSet].some((task) => ['writing', 'writer', 'landing', 'seo_gap', 'seo'].includes(task))) return 'preparation';
  ...
  if (/(writing|writer|copy|landing|seo_gap|content|draft|creative|prepare)/.test(text)) return 'preparation';
