...
const APP_CONTEXT_RAW_CONTRACT_ALIASES = Object.freeze({
  ...
  growth_experiment_packet: ['growthExperimentPacket', 'growth_packet', 'growthPacket', 'experiment_packet', 'experimentPacket', 'growth_plan_packet', 'growthPlanPacket'],
  growth_asset_handoff_packet: ['growthAssetHandoffPacket', 'growth_asset_packet', 'growthAssetPacket', 'asset_handoff_packet', 'assetHandoffPacket'],
  growth_activation_handoff_packet: ['growthActivationHandoffPacket', 'growth_activation_packet', 'growthActivationPacket', 'activation_handoff_packet', 'activationHandoffPacket'],
  ...
  execution_packet: ['executionPacket', 'activation_packet', 'activationPacket'],
  tracking_specification: ['trackingSpecification', 'tracking_spec', 'trackingSpec', 'measurement_spec', 'measurementSpec'],
  metric_threshold: ['metricThreshold', 'success_metric', 'successMetric', 'threshold'],
  kill_rule: ['killRule', 'stop_rule', 'stopRule'],
