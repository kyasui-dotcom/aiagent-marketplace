...
const APP_CONTEXT_RAW_CONTRACT_ALIASES = Object.freeze({
  ...
  growth_publisher_handoff_packet: ['growthPublisherHandoffPacket', 'growth_launch_packet', 'growthLaunchPacket', 'publisher_activation_packet', 'publisherActivationPacket', 'growth_to_publisher_packet', 'growthToPublisherPacket'],
  growth_launch_packet: ['growthLaunchPacket', 'growth_publisher_handoff_packet', 'growthPublisherHandoffPacket', 'publisher_activation_packet', 'publisherActivationPacket', 'growth_to_publisher_packet', 'growthToPublisherPacket'],
  publisher_activation_packet: ['publisherActivationPacket', 'growth_publisher_handoff_packet', 'growthPublisherHandoffPacket', 'growth_launch_packet', 'growthLaunchPacket', 'growth_to_publisher_packet', 'growthToPublisherPacket'],
  growth_to_publisher_packet: ['growthToPublisherPacket', 'growth_publisher_handoff_packet', 'growthPublisherHandoffPacket', 'growth_launch_packet', 'growthLaunchPacket', 'publisher_activation_packet', 'publisherActivationPacket'],
  ...
  x_account: ['xAccount', 'account', 'target_account', 'targetAccount'],
  reply_target: ['replyTarget', 'reply_to', 'replyTo', 'reply_to_tweet_id', 'replyToTweetId', 'target_url', 'targetUrl'],
  thread_context: ['threadContext', 'conversation_context', 'conversationContext'],
  posting_window: ['postingWindow', 'schedule_window', 'scheduleWindow', 'scheduled_for', 'scheduledFor'],
...
const APP_CONTEXT_MULTILINE_PRESERVE_KEYS = Object.freeze(uniqueStringList([
  ...
  'asset_readiness_matrix',
  'assetReadinessMatrix',
  'media_readiness_matrix',
  'mediaReadinessMatrix',
  'visual_asset_gap',
  'visualAssetGap',
  'next_decision',
  'nextDecision'
