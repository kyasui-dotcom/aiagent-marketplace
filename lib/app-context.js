...
const APP_CONTEXT_RAW_CONTRACT_ALIASES = Object.freeze({
  ...
  ads_plan: ['adsPlan', 'ads_plan_packet', 'adsPlanPacket', 'paid_ads_plan', 'paidAdsPlan'],
  ads_plan_packet: ['adsPlanPacket', 'ads_plan', 'adsPlan', 'paid_ads_plan', 'paidAdsPlan'],
  paid_ads_plan: ['paidAdsPlan', 'ads_plan', 'adsPlan', 'ads_plan_packet', 'adsPlanPacket'],
  campaign_structure: ['campaignStructure'],
  budget_cap_and_cpa_assumption: ['budgetCapAndCpaAssumption', 'budget_guardrails', 'budgetGuardrails', 'budgetCap', 'targetCpa'],
  budget_guardrails: ['budgetGuardrails', 'budget_cap_and_cpa_assumption', 'budgetCapAndCpaAssumption'],
  stop_rules: ['stopRules'],
  creative_asset_packet: ['creativeAssetPacket'],
  ads_saas_handoff: ['adsSaasHandoff', 'ads_saas_handoff_packet', 'adsSaasHandoffPacket'],
  ads_saas_handoff_packet: ['adsSaasHandoffPacket', 'ads_saas_handoff', 'adsSaasHandoff'],
  approval_and_launch_boundary: ['approvalAndLaunchBoundary'],
  launch_approval_handoff: ['launchApprovalHandoff'],
  execution_status_labels: ['executionStatusLabels'],
...
function shouldPreserveMultilineValue(key = '') {
  return /^(?:content|content_preview|contentPreview|body|text|markdown|html|raw_markdown|rawMarkdown|campaign_operations_plan|campaignOperationsPlan|campaignOpsPlan|campaignPlan|campaign_markdown|campaignMarkdown|ads_plan|adsPlan|ads_plan_packet|adsPlanPacket|paid_ads_plan|paidAdsPlan)$/i.test(String(key || '').trim());
}
