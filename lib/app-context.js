...
const APP_CONTEXT_RAW_CONTRACT_ALIASES = Object.freeze({
  ...
  delivery_artifacts: ['deliveryArtifacts', 'deliveryFiles', 'delivery_files', 'files'],
...
export function normalizeCaitAppContext(raw = {}) {
  ...
  return {
    ...
    delivery_files: objectList(source.delivery_files || source.deliveryFiles || source.files || [], 30),
