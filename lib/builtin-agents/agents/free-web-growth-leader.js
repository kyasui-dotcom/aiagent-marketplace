...
const FREE_WEB_GROWTH_AGENT_PURPOSE = 'Lead no-paid growth by choosing organic channels, assigning specialist packets, and preparing handoffs without claiming publishing, outreach, or external app execution.';

const FREE_WEB_GROWTH_AGENT_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    id: 'prepare_no_paid_growth_plan',
    mode: 'leader_strategy',
    requires: Object.freeze(['product_or_offer', 'audience', 'growth_goal', 'no_paid_constraint']),
    prepares: Object.freeze(['organic_channel_plan', '24_hour_plan', '7_day_plan']),
    produces: Object.freeze(['no_paid_growth_plan_packet']),
    cannotClaim: Object.freeze(['published', 'posted', 'sent', 'submitted']),
    authorityBoundary: 'Execution belongs to each specialist, Publisher surface, or SaaS connector after approval.'
  }),
  Object.freeze({
    id: 'prepare_specialist_handoff_queue',
    mode: 'leader_to_specialist_handoff',
    requires: Object.freeze(['approved_channel_priority', 'owner_or_next_agent']),
    prepares: Object.freeze(['specialist_assignment_queue', 'approval_gates']),
    produces: Object.freeze(['organic_specialist_handoff_packet']),
    cannotClaim: Object.freeze(['specialist completed work', 'external app ingested']),
    authorityBoundary: 'Handoff is ready only after each owner, artifact, and proof requirement is named.'
  })
]);

const FREE_WEB_GROWTH_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Growth goal', 'No-paid constraint', 'Channel priority', '24-hour plan', '7-day plan', 'Specialist queue', 'Approval gates', 'Measurement loop']),
  requiredEvidence: Object.freeze(['supplied product/site context', 'known channel constraints or assumptions']),
  mustLabel: Object.freeze(['assumptions', 'execution owner', 'approval needed']),
  forbiddenClaims: Object.freeze(['published', 'posted', 'sent', 'directory submitted', 'external app executed']),
  validDeliveryCheck: 'A valid free-web-growth delivery is an organic growth operating packet, not a claim that channels were executed.'
});

const AGENT_DEFINITION = {
  provider: AGENT_PROVIDER,
  agentPurpose: FREE_WEB_GROWTH_AGENT_PURPOSE,
  agentActionBoundaries: FREE_WEB_GROWTH_AGENT_ACTION_BOUNDARIES,
  deliveryContract: FREE_WEB_GROWTH_DELIVERY_CONTRACT,
