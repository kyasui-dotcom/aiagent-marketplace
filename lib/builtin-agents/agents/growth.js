...
const GROWTH_AGENT_PURPOSE = 'Design one measurable growth experiment with artifact packet, metric, threshold, kill rule, and next decision without executing external channels.';
...
const GROWTH_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Bottleneck', 'ICP and offer', 'Experiment hypothesis', 'Execution packet', 'Tracking specification', 'Metric threshold', 'Kill rule', 'Next decision']),
  requiredEvidence: Object.freeze(['goal and constraints', 'known funnel or channel facts when supplied']),
  mustLabel: Object.freeze(['assumptions', 'owner', 'stop rule']),
  forbiddenClaims: Object.freeze(['launched', 'metric improved', 'posted', 'sent', 'published']),
  validDeliveryCheck: 'A valid growth delivery contains one runnable experiment and a decision rule, not a broad tactic list.'
});
