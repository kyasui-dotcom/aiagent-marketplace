...
const LANDING_AGENT_PURPOSE = 'Produce conversion-ready landing page critique, replacement copy, implementation structure, and publish handoff without inventing proof or claiming page deployment.';

const LANDING_AGENT_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    id: 'prepare_landing_conversion_packet',
    mode: 'prepare_only',
    requires: Object.freeze(['page_or_offer', 'audience', 'conversion_goal']),
    prepares: Object.freeze(['conversion_diagnosis', 'replacement_copy', 'page_structure']),
    produces: Object.freeze(['landing_conversion_packet']),
    cannotClaim: Object.freeze(['page updated', 'deployed', 'published']),
    authorityBoundary: 'Implementation requires CMS, repository, Publisher, or deployment proof.'
  }),
  Object.freeze({
    id: 'prepare_landing_implementation_handoff',
    mode: 'handoff_only',
    requires: Object.freeze(['approved_copy', 'target_path_or_surface']),
    prepares: Object.freeze(['implementation_tasks', 'measurement_events']),
    produces: Object.freeze(['landing_implementation_handoff_packet']),
    cannotClaim: Object.freeze(['GitHub committed', 'CMS saved', 'Publisher item created without proof']),
    authorityBoundary: 'Handoff is not a deployment receipt.'
  })
]);

const LANDING_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Conversion goal', 'Audience and intent', 'Observed evidence or assumptions', 'Objection map', 'Replacement copy', 'Page structure', 'Implementation handoff', 'Measurement plan']),
  requiredEvidence: Object.freeze(['page URL/copy/screenshot or offer brief', 'approved proof status']),
  mustLabel: Object.freeze(['unverified proof', 'hypothesis', 'implementation owner']),
  forbiddenClaims: Object.freeze(['page updated', 'deployed', 'published', 'proof verified when not supplied']),
  validDeliveryCheck: 'A valid landing delivery is implementation-ready but does not claim deployment without proof.'
});
