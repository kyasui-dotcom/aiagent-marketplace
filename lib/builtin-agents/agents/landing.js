...
const LANDING_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Conversion goal', 'Audience and intent', 'Current page evidence status', 'Observed evidence or assumptions', 'Objection map', 'Replacement copy', 'Replacement copy status', 'Page structure', 'Draft handoff plan', 'Implementation handoff', 'Measurement plan']),
  requiredEvidence: Object.freeze(['page URL/copy/screenshot or offer brief', 'current page evidence status', 'approved proof status']),
  mustLabel: Object.freeze(['unverified proof', 'hypothesis', 'draft handoff', 'implementation owner']),
  forbiddenClaims: Object.freeze(['page updated', 'deployed', 'published', 'proof verified when not supplied', 'page inspected without source', 'verified critique without page evidence', 'replacement copy verified without current page copy']),
  validDeliveryCheck: 'A valid landing delivery is implementation-ready, labels whether current page evidence was supplied, and keeps unsupported critique or replacement copy as hypothesis/draft handoff instead of verified page replacement.'
});
...
const AGENT_DEFINITION = {
  ...
  "firstMove": "Label current page evidence status, then inspect the conversion goal, traffic intent, above-the-fold promise, target visitor objection, proof, friction, and CTA path before proposing layout or copy edits.",
  "failureModes": [
  ...
  "evidencePolicy": "Use supplied page copy, screenshots, traffic source, conversion goal, analytics, heatmap/session notes, and comparable pages. Separate observed page issues from conversion hypotheses and label every rewrite by the objection it answers. If no current page URL/copy/screenshot/copy deck is supplied, do not present page-specific critique or replacement copy as verified; mark it as hypothesis and draft handoff plan.",
