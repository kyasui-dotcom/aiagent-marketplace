...
const LANDING_AGENT_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    ...
    prepares: Object.freeze(['conversion_diagnosis', 'replacement_copy', 'page_structure', 'evidence_status_labels', 'missing_page_copy_request']),
    produces: Object.freeze(['landing_conversion_packet']),
    cannotClaim: Object.freeze(['page inspected without source', 'verified critique without page evidence', 'current section critique without current page copy', 'page updated', 'deployed', 'published']),
    authorityBoundary: 'If current page copy or current sections are missing, keep output to generalized improvements and request the missing page copy/sections; do not provide section-specific critique or replacement as verified.'
  }),
  Object.freeze({
...
const LANDING_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Conversion goal', 'Audience and intent', 'Current page evidence status', 'Missing page copy/sections stop rule', 'Signup/trial CTA alignment check', 'Intent to CTA mapping', 'Revised CTA block draft', 'Proof block draft', 'Observed evidence or assumptions', 'Objection map', 'Replacement copy', 'Replacement copy status', 'Page structure', 'Draft handoff plan', 'Implementation handoff', 'Measurement plan']),
  requiredEvidence: Object.freeze(['page URL/copy/screenshot or offer brief', 'current page evidence status', 'current page copy or section inventory', 'visitor intent source', 'signup/trial page copy or URL', 'SEO landing page URL', 'approved proof status']),
  mustLabel: Object.freeze(['unverified proof', 'hypothesis', 'draft handoff', 'implementation owner', 'CTA mismatch', 'alignment unverified', 'draft CTA', 'proof placeholder', 'generalized improvement only', 'missing page copy/sections']),
  forbiddenClaims: Object.freeze(['page updated', 'deployed', 'published', 'proof verified when not supplied', 'page inspected without source', 'verified critique without page evidence', 'replacement copy verified without current page copy', 'CTA alignment verified without both page sources', 'SEO page inspected without URL', 'signup/trial page inspected without copy or URL', 'proof block approved without supplied proof', 'section-specific rewrite without current page copy']),
  validDeliveryCheck: 'A valid landing delivery is implementation-ready, labels whether current page evidence was supplied, checks signup/trial CTA alignment against the SEO landing page when both sources exist, includes intent-to-CTA mapping plus revised CTA and proof block drafts, and when current page copy/sections are missing keeps output generalized and requests the missing inputs.'
});
...
const AGENT_DEFINITION = {
  ...
  "outputSections": [
    ...
    "Missing page copy/sections stop rule",
  ...
  "inputNeeds": [
    ...
    "Current page copy or section inventory",
  ...
  "acceptanceChecks": [
    ...
    "Missing current page copy/sections limits the output to generalized improvements plus input request",
  ...
  "firstMove": "Label current page evidence status, current page copy/sections status, signup/trial page source status, and SEO landing page source status, then inspect the conversion goal, traffic intent, above-the-fold promise, target visitor objection, proof, friction, and CTA path before mapping intent to CTA and proposing layout or copy edits.",
  "failureModes": [
    ...
    "Do not provide section-specific critique or rewrite when current page copy/sections are missing",
  ...
  "evidencePolicy": "Use supplied page copy, screenshots, section inventory, traffic source, conversion goal, analytics, heatmap/session notes, signup/trial page copy or URL, SEO landing page URL, visitor/search intent, approved proof assets, and comparable pages. Separate observed page issues from conversion hypotheses and label every rewrite by the objection it answers. If no current page copy or section inventory is supplied, keep only generalized improvements and request the missing current page copy/sections. If no current page URL/copy/screenshot/copy deck is supplied, do not present page-specific critique or replacement copy as verified; mark it as hypothesis and draft handoff plan. If signup/trial or SEO page source is missing, do not present CTA alignment as verified. If proof assets are missing, draft proof placeholders and label them as not approved proof.",
  ...
  "confidenceRubric": "High when page copy/sections, signup/trial page source, SEO landing page URL, audience, traffic source, goal, proof assets, and comparable pages are available; medium when only partial copy is supplied; low when conversion goal, audience, proof, traffic intent, page copy/sections, or one alignment page source is unclear.",
  "handoffArtifacts": [
    "Page diagnosis",
  ...
  "escalationTriggers": [
    ...
    "Current page copy or section inventory is missing for a page-specific critique or rewrite",
  ...
  "minimumQuestions": [
    ...
    "What current page copy or sections should be critiqued or rewritten?",
  ...
  "reviewChecks": [
    ...
    "Missing current page copy/sections produces only generalized improvements and missing-input request",
  ...
  "specialistMethod": [
    ...
    "Classify the current page evidence and current page copy/sections as observed, source-supplied, or missing before making critique claims.",
    "If current page copy/sections are missing, keep improvements generalized and request the exact missing copy/section inputs before page-specific critique.",
