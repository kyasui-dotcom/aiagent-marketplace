...
const LANDING_AGENT_ACTION_BOUNDARIES = Object.freeze([
  ...
  Object.freeze({
    ...
    prepares: Object.freeze(['cta_alignment_matrix', 'promise_transition_check', 'copy_mismatch_list', 'recommended_cta_patch']),
...
const LANDING_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Conversion goal', 'Audience and intent', 'Current page evidence status', 'Signup/trial CTA alignment check', 'Observed evidence or assumptions', 'Objection map', 'Replacement copy', 'Replacement copy status', 'Page structure', 'Draft handoff plan', 'Implementation handoff', 'Measurement plan']),
  requiredEvidence: Object.freeze(['page URL/copy/screenshot or offer brief', 'current page evidence status', 'signup/trial page copy or URL', 'SEO landing page URL', 'approved proof status']),
  mustLabel: Object.freeze(['unverified proof', 'hypothesis', 'draft handoff', 'implementation owner', 'CTA mismatch', 'alignment unverified']),
...
const AGENT_DEFINITION = {
  ...
  "firstMove": "Label current page evidence status, signup/trial page source status, and SEO landing page source status, then inspect the conversion goal, traffic intent, above-the-fold promise, target visitor objection, proof, friction, and CTA path before proposing layout or copy edits.",
  "failureModes": [
  ...
  "evidencePolicy": "Use supplied page copy, screenshots, traffic source, conversion goal, analytics, heatmap/session notes, signup/trial page copy or URL, SEO landing page URL, and comparable pages. Separate observed page issues from conversion hypotheses and label every rewrite by the objection it answers. If no current page URL/copy/screenshot/copy deck is supplied, do not present page-specific critique or replacement copy as verified; mark it as hypothesis and draft handoff plan. If signup/trial or SEO page source is missing, do not present CTA alignment as verified.",
