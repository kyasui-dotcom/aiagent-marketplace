...
const ACQUISITION_AUTOMATION_AGENT_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    id: 'prepare_acquisition_flow_packet',
    mode: 'automation_design',
    requires: Object.freeze(['conversion_goal', 'trigger_or_segment']),
    prepares: Object.freeze(['trigger_map', 'state_machine', 'message_sequence', 'stop_rules']),
  ...
  Object.freeze({
    id: 'prepare_connector_activation_handoff',
    mode: 'handoff_only',
    requires: Object.freeze(['approved_flow', 'connector_surface', 'approval_owner']),
    prepares: Object.freeze(['activation_checklist', 'field_mapping', 'measurement_spec']),
