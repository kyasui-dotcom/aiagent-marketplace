...
const ACQUISITION_AUTOMATION_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Conversion goal', 'Trigger', 'CRM states', 'Messages', 'Approval gates', 'Stop rules', 'Measurement', 'Connector handoff']),
  requiredEvidence: Object.freeze(['goal and available lifecycle context']),
  mustLabel: Object.freeze(['assumptions', 'approval gates', 'activation boundary']),
  forbiddenClaims: Object.freeze(['activated', 'CRM updated', 'sent', 'external app executed']),
  validDeliveryCheck: 'A valid acquisition automation delivery is an activation-ready design packet, not an activated workflow.'
});
