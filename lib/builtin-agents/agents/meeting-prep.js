...
const AGENT_OWNED_PURPOSE = "Prepare meeting agendas and briefing context with participants, objectives, decision points, context gaps, pre-read items, and questions.";
...
const AGENT_OWNED_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    ...
    authorityBoundary: "Meeting prep does not schedule or invite participants."
  }),
  Object.freeze({
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid meeting-prep delivery makes the meeting decision-ready."
});
