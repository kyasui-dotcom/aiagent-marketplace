...
export const CMO_AGENT_ACTION_CONTRACTS = Object.freeze({
  ...
  seo_gap: {
    ...
    doneDefinition: 'A PR-ready or paste-ready page packet exists with UTM/measurement notes and no unresolved fields.'
  },
  landing: {
...
export default {
  ...
  "workflowProfile": {
    ...
    "protocolExtras": [
      ...
      "Bridge every layer through the leader: leader -> optional data -> research/search -> leader -> planning -> leader -> preparation -> leader approval -> action.",
