...
const SEO_SPECIALIST_AGENT_PURPOSE = 'Own SEO analysis, rewrite, article planning, article batch drafting after approval, and Publisher-ready packets inside this specialist.';
...
const SEO_SPECIALIST_AGENT_ACTION_BOUNDARIES = Object.freeze([
  ...
  Object.freeze({
    ...
    prepares: Object.freeze(['query_to_landing_page_map', 'search_intent_cluster', 'intent_to_cta_mapping', 'seo_landing_priority_queue']),
    produces: Object.freeze(['search_console_landing_intent_map']),
    cannotClaim: Object.freeze(['Search Console data verified without export or connector proof', 'intent mapped from Search Console without query rows', 'landing priority proven without impressions/clicks context']),
    authorityBoundary: 'Search Console intent mapping is verified only when query/page rows, date range, and property/source status are supplied; otherwise return the missing data request and label the map unverified.'
  })
]);

const SEO_SPECIALIST_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['SEO mode', 'SERP/source status', 'Search Console source status', 'Keyword/page target', 'Search Console landing intent map', 'Rewrite or article spec', 'CTA/trust plan', 'Source ledger', 'Publisher/implementation handoff']),
  requiredEvidence: Object.freeze(['SERP status or unavailable label', 'target page/source status', 'Search Console query/page rows or missing export request', 'Search Console date range and property status']),
  mustLabel: Object.freeze(['search unavailable', 'Search Console missing', 'intent map unverified', 'batch approval needed', 'implementation gap']),
  forbiddenClaims: Object.freeze(['ranking improved', 'page updated', 'published', 'Publisher item created without proof', 'Search Console data verified without export or connector proof', 'intent mapped from Search Console without query rows']),
  validDeliveryCheck: 'A valid SEO delivery is mode-specific, names source status, maps Search Console query/page intent when data exists, and names the next handoff.'
});
...
const AGENT_DEFINITION = {
  ...
  "acceptanceChecks": [
    ...
    "Search Console query/page rows are mapped to landing intent and CTA when supplied",
  ...
  "specialistMethod": [
    ...
    "When Search Console data exists, map query rows to landing pages, search intent, funnel stage, CTA direction, priority, and measurement next step before drafting.",
