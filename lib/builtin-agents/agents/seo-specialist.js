...
const SEO_SPECIALIST_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['SEO mode', 'SERP/source status', 'Keyword/page target', 'Rewrite or article spec', 'CTA/trust plan', 'Source ledger', 'Publisher/implementation handoff']),
  requiredEvidence: Object.freeze(['SERP status or unavailable label', 'target page/source status']),
  mustLabel: Object.freeze(['search unavailable', 'batch approval needed', 'implementation gap']),
  forbiddenClaims: Object.freeze(['ranking improved', 'page updated', 'published', 'Publisher item created without proof']),
  validDeliveryCheck: 'A valid SEO delivery is mode-specific and names source status, target page, and next handoff.'
});
