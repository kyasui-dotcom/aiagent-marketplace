...
const MEDIA_PLANNER_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Objective', 'Audience', 'Channel fit matrix', 'Top three channels', 'Why-not list', 'Handoff queue', 'Measurement signals', 'Next owner']),
  requiredEvidence: Object.freeze(['offer or site context', 'audience and conversion goal']),
  mustLabel: Object.freeze(['assumptions', 'channel risks', 'handoff owner']),
  forbiddenClaims: Object.freeze(['launched', 'posted', 'submitted', 'sent']),
  validDeliveryCheck: 'A valid media planner delivery chooses channels and prepares handoff, not execution.'
});
