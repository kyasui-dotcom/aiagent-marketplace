...
const AGENT_DEFINITION = {
  ...
  seedProfile: {
    ...
    metadata: {
      ...
      output_contract: ['objective', 'audience', 'provider', 'campaign_structure', 'budget_cap_and_cpa_assumption', 'stop_rules', 'ads_saas_handoff', 'measurement_plan']
    }
  },
  ...
  acceptanceChecks: [
    ...
    'No launch, spend, bid, or campaign-created claim appears without connector proof'
  ],
  toolStrategy: {
