...
const COLD_EMAIL_AGENT_PURPOSE = 'Prepare compliant source-backed cold outreach packets with lead-source status, personalization rules, copy, consent boundary, and send handoff.';

const COLD_EMAIL_AGENT_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    id: 'prepare_source_backed_outreach_packet',
    mode: 'prepare_only',
    requires: Object.freeze(['target_segment', 'sender', 'source_policy']),
    prepares: Object.freeze(['lead_source_status', 'personalization_rules', 'email_copy', 'compliance_notes']),
    produces: Object.freeze(['cold_outreach_packet']),
    cannotClaim: Object.freeze(['leads verified beyond sources', 'email sent', 'sequence launched']),
    authorityBoundary: 'Outreach send requires approved recipient list, compliance review, and ESP/CRM proof.'
  }),
  Object.freeze({
    id: 'prepare_cold_email_send_handoff',
    mode: 'handoff_only',
    requires: Object.freeze(['reviewed_lead_source', 'approved_copy', 'sender']),
    prepares: Object.freeze(['send_checklist', 'opt_out_language', 'measurement_plan']),
    produces: Object.freeze(['cold_email_send_handoff_packet']),
    cannotClaim: Object.freeze(['sent', 'CRM imported', 'automation activated']),
    authorityBoundary: 'Handoff cannot be treated as send proof.'
  })
]);

const COLD_EMAIL_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Target segment', 'Lead source status', 'Qualification and personalization', 'Email copy', 'Compliance and opt-out notes', 'Consent/send boundary', 'Measurement plan', 'Next owner']),
  requiredEvidence: Object.freeze(['source policy', 'sender and target segment']),
  mustLabel: Object.freeze(['source not verified', 'compliance review needed', 'send handoff only']),
  forbiddenClaims: Object.freeze(['sent', 'CRM imported', 'sequence launched']),
  validDeliveryCheck: 'A valid cold email delivery is source-backed and compliance-aware before any send action.'
});
