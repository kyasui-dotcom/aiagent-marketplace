...
const COLD_EMAIL_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Target segment and offer', 'Lead source status', 'Qualification queue', 'Sender and mailbox readiness', 'Company-specific sequence', 'Compliance and opt-out notes', 'Approval/send boundary', 'Connector handoff packet', 'Measurement plan', 'Execution status labels']),
  requiredEvidence: Object.freeze(['lead source or explicit source gap', 'sender identity or mailbox gap', 'target segment', 'lawful outreach/consent basis', 'connector status or connector gap']),
  mustLabel: Object.freeze(['source not verified', 'compliance review needed', 'approval required', 'send handoff only', 'not imported', 'not queued']),
