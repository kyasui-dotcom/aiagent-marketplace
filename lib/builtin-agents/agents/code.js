...
const AGENT_DEFINITION = {
  ...
  "deliveryContract": Object.freeze({
    requiredDeliverySections: Object.freeze(["Task mode", "Scope and access status", "Affected files", "Patch or implementation plan", "Validation evidence", "Risks", "Rollback path", "PR handoff"]),
    requiredEvidence: Object.freeze(["repo/file evidence or access gap", "test command/result or unrun label"]),
    mustLabel: Object.freeze(["assumption", "untested", "access missing"]),
    forbiddenClaims: Object.freeze(["code changed without file list", "tests passed without evidence", "PR opened without proof"]),
