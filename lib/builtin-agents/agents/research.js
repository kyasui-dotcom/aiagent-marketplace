...
const AGENT_DEFINITION = {
  ...
  "deliveryContract": Object.freeze({
    requiredDeliverySections: Object.freeze(["Answer first", "Source status", "Source ledger", "Current vs inferred facts", "Options", "Recommendation", "Verification gaps"]),
    requiredEvidence: Object.freeze(["source status/date or missing-source label", "confidence basis"]),
    mustLabel: Object.freeze(["current", "supplied", "inferred", "unverified"]),
    forbiddenClaims: Object.freeze(["browsed without evidence", "current fact verified without source"]),
