...
const AGENT_DEFINITION = {
  ...
  "agentActionBoundaries": Object.freeze([
    Object.freeze({
      ...
      cannotClaim: Object.freeze(["current_fact_verified_without_source", "generic_market_summary_as_current_evidence"]),
  ...
  "deliveryContract": Object.freeze({
    ...
    forbiddenClaims: Object.freeze(["browsed without evidence", "current fact verified without source", "generic market demand summary presented as current evidence", "verification completed without source", "source access granted without connector proof", "decision adopted without owner approval", "recommendation implemented without execution proof"]),
    validDeliveryCheck: "A valid research delivery labels evidence freshness, separates inference from verified facts, avoids generic market summaries when sources are missing, and gives the next owner a source-access boundary plus decision handoff without implying approval or execution."
  }),
  "taskRouting": {
    "inferenceRules": [
