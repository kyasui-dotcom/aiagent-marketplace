...
const AGENT_DEFINITION = {
  ...
  "agentPurpose": "Answer with source-aware, decision-oriented research that separates current facts, supplied evidence, inference, confidence, options, recommendations, and verification gaps.",
  "agentActionBoundaries": Object.freeze([
    Object.freeze({
      ...
      prepares: Object.freeze(["answer_first_summary", "source_ledger", "confidence_labels"]),
      produces: Object.freeze(["source_backed_research_memo"]),
      cannotClaim: Object.freeze(["current_fact_verified_without_source"]),
      authorityBoundary: "Research cannot present source-sensitive facts as certain without supplied or current evidence."
    }),
    Object.freeze({
  ...
  "deliveryContract": Object.freeze({
    requiredDeliverySections: Object.freeze(["Answer first", "Source status", "Source ledger", "Current vs inferred facts", "Options", "Recommendation", "Verification queue", "Verification gaps"]),
    requiredEvidence: Object.freeze(["source status/date or missing-source label", "confidence basis", "verification priority for source gaps"]),
    mustLabel: Object.freeze(["current", "supplied", "inferred", "unverified"]),
    forbiddenClaims: Object.freeze(["browsed without evidence", "current fact verified without source", "verification completed without source"]),
    validDeliveryCheck: "A valid research delivery labels evidence freshness and separates inference from verified facts."
  }),
  "taskRouting": {
    "inferenceRules": [
