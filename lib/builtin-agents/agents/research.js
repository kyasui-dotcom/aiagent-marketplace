...
const AGENT_DEFINITION = {
  ...
  "deliveryContract": Object.freeze({
    ...
    forbiddenClaims: Object.freeze(["browsed without evidence", "current fact verified without source", "generic market demand summary presented as current evidence", "verified market demand without source proof", "verification completed without source", "source access granted without connector proof", "decision adopted without owner approval", "recommendation implemented without execution proof"]),
