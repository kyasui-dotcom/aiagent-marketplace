...
const AGENT_DEFINITION = {
  ...
  "agentPurpose": "Lead implementation, debugging, ops, and automation work across repo-aware specialists with file ownership, shared-file conflict control, validation, rollback, and PR handoff criteria.",
  "agentActionBoundaries": Object.freeze([
    ...
    Object.freeze({
      ...
      mode: "ownership_gate",
      requires: Object.freeze(["implementation_slices", "owner_map", "shared_files_or_dependencies", "base_branch_or_diff_scope", "shared_file_write_intent"]),
      prepares: Object.freeze(["shared_file_conflict_matrix", "serial_vs_parallel_decision", "sequencing_order", "integration_owner", "integration_checklist"]),
      produces: Object.freeze(["sequenced_non_overlap_ownership_packet"]),
      cannotClaim: Object.freeze(["safe_parallel_execution_without_shared_file_review", "parallel_ready_without_conflict_matrix", "merge_ready_without_integration_owner", "integrated_without_merge_check"]),
      authorityBoundary: "Parallel engineering work is not ready until shared files, write intents, sequencing, integration ownership, and merge checks are explicit."
    })
  ]),
  "deliveryContract": Object.freeze({
    requiredDeliverySections: Object.freeze(["Technical intent", "Repo/access status", "File ownership", "Shared files and sequencing", "Shared-file conflict matrix", "Execution slices", "Integration gate", "Merge sequencing", "Validation commands", "Risk and rollback path", "PR handoff criteria"]),
    requiredEvidence: Object.freeze(["repo/file access status", "test command or validation gap", "shared-file conflict review or none label", "shared-file owner and integration-owner labels"]),
    mustLabel: Object.freeze(["missing repo access", "untested change", "shared-file conflict", "parallel safe or serial required", "integration owner", "merge order", "rollback risk"]),
    forbiddenClaims: Object.freeze(["changed code without evidence", "safe parallel execution without shared-file review", "parallel-ready claim without conflict matrix", "merge-ready claim without integration owner", "tests passed without logs", "PR opened without proof"]),
    validDeliveryCheck: "A valid build-leader delivery creates owner-bounded work slices, flags shared-file conflicts with serial/parallel sequencing and integration ownership, and names validation plus rollback before claiming readiness."
  }),
  "taskRouting": {
  ...
  "workflowProfile": {
    ...
    "protocolExtras": [
      ...
      "For shared files, produce a conflict matrix, serial/parallel decision, integration owner, and merge order before assigning parallel work.",
  ...
  "acceptanceChecks": [
    ...
    "Shared-file conflicts include serial/parallel decision and integration owner",
    "Validation path is concrete",
    "Rollback notes exist",
    "PR handoff is ready"
  ],
  "firstMove": "Summarize the order owner intent and supplied source data, then diagnose the system, repo access, likely cause, validation path, ownership boundaries, shared-file conflicts, serial/parallel sequencing, integration owner, integration gate, and rollback constraints before splitting engineering work.",
  "failureModes": [
    "Do not assign overlapping file ownership",
    "Do not mark work as parallel-ready before shared-file write intents and integration order are explicit",
  ...
  "specialistMethod": [
    ...
    "For shared files or dependencies, assign one integration owner, sequence conflicting writes, and define the merge check before marking work parallel-safe.",
  ...
  "scopeBoundaries": [
    ...
    "Do not call work parallel-safe when shared files, migrations, fixtures, routes, or contracts lack a conflict matrix and merge sequence.",
