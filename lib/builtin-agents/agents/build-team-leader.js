...
const AGENT_DEFINITION = {
  ...
  "deliveryContract": Object.freeze({
    requiredDeliverySections: Object.freeze(["Technical intent", "Repo/access status", "File ownership", "Execution slices", "Validation commands", "Risk and rollback path", "PR handoff criteria"]),
    requiredEvidence: Object.freeze(["repo/file access status", "test command or validation gap"]),
    mustLabel: Object.freeze(["missing repo access", "untested change", "rollback risk"]),
    forbiddenClaims: Object.freeze(["changed code without evidence", "tests passed without logs", "PR opened without proof"]),
