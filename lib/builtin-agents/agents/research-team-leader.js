...
const AGENT_OWNED_PURPOSE = "Coordinate research specialists and synthesize evidence with non-overlap, source plans, evidence acceptance rules, confidence grading, and next decision.";
...
const AGENT_OWNED_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    ...
    authorityBoundary: "Source planning does not verify facts."
  }),
  Object.freeze({
    ...
    authorityBoundary: "Synthesis must retain source status and confidence from inputs."
  })
]);
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid research leader delivery prevents duplicate research and grades evidence."
});
