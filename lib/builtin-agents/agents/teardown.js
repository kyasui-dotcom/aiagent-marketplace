...
const AGENT_OWNED_PURPOSE = "Produce competitive analysis that changes positioning or product decisions by separating observed facts, dated evidence, inference, wedge, and first test.";
...
const AGENT_OWNED_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    ...
    authorityBoundary: "Competitive claims must be dated and source-labeled."
  }),
  Object.freeze({
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid teardown delivery produces a differentiated move grounded in observed evidence."
});
