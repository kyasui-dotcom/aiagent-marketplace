...
const X_POST_AGENT_PURPOSE = 'Prepare X-native posts, threads, replies, cadence, approval checklist, and connector handoff without claiming unapproved X actions.';
...
const X_POST_AGENT_ACTION_BOUNDARIES = Object.freeze([
  ...
  Object.freeze({
    ...
    mode: 'handoff_only',
    requires: Object.freeze(['approved_exact_text', 'connected_account_handle', 'human_publish_confirmation']),
    prepares: Object.freeze(['connector_fields', 'approval_checklist', 'audit_note']),
...
const X_POST_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Positioning and voice', 'Exact post text', 'Thread or short-post set', 'Reply hooks', 'Cadence', 'Approval checklist', 'Connector handoff boundary']),
  requiredEvidence: Object.freeze(['voice/source examples or assumption label']),
  mustLabel: Object.freeze(['draft only', 'approval required', 'connector gap']),
  forbiddenClaims: Object.freeze(['posted', 'scheduled', 'liked', 'replied']),
  validDeliveryCheck: 'A valid X delivery contains exact text and explicit approval/connector boundary.'
});
