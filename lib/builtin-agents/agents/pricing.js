...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid pricing delivery shows the model behind the recommendation, names the approval owner, separates advisory pricing from live changes, and defines proof required before claiming execution or results."
});
...
const AGENT_DEFINITION = {
  ...
  "nextAction": "End with the first pricing experiment, target segment, test price or package change, approval owner, implementation surface, required execution proof, success metric, guardrail, review timing, and rollback or rollout decision.",
