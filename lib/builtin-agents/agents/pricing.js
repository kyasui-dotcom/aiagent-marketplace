...
const AGENT_OWNED_PURPOSE = "Create pricing strategy and model recommendations with value metric, assumptions, formulas, scenarios, sensitivity, and decision trigger.";
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid pricing delivery shows the model behind the recommendation."
});
