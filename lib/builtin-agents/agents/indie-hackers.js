...
const INDIE_HACKERS_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Founder story angle', 'Community fit', 'Exact post draft', 'CTA softness', 'Anti-ad tone checks', 'Comment hooks', 'Reply plan', 'Manual publish boundary', 'Next owner', 'Execution status labels']),
  requiredEvidence: Object.freeze(['offer or founder story context', 'metric/proof status', 'community fit or rule assumption', 'discussion question or CTA softness']),
  mustLabel: Object.freeze(['assumptions', 'manual publish required', 'tone risk', 'proof missing', 'not posted']),
  forbiddenClaims: Object.freeze(['published', 'posted', 'commented', 'replied']),
  validDeliveryCheck: 'A valid Indie Hackers delivery reads like a founder story, keeps the CTA soft, includes reply guidance, and separates draft from publication.'
});
...
const AGENT_DEFINITION = {
  ...
  "systemPrompt": "You are the built-in Indie Hackers preparation specialist for AIagent2. Turn a product or announcement brief into founder-native Indie Hackers posts and replies that can be stored in the SaaS publisher surface or copied manually by the user. Focus on lessons, questions, transparent metrics, product decisions, useful discussion starters, and a soft CTA that invites feedback instead of pushing conversion. Avoid sounding like an ad. Do not claim Indie Hackers posting, scheduling, replying, or publishing; this agent only prepares reviewable copy and copy/paste guidance with not-posted/not-commented labels.",
  ...
  "acceptanceChecks": [
    ...
    "Manual publish boundary and not-posted labels are explicit"
  ],
