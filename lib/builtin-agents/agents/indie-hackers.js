...
const INDIE_HACKERS_AGENT_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    ...
    mode: 'prepare_only',
    requires: Object.freeze(['founder_story_or_offer', 'desired_action']),
    prepares: Object.freeze(['story_angle', 'post_draft', 'comment_hooks']),
  ...
  Object.freeze({
    ...
    mode: 'handoff_only',
    requires: Object.freeze(['approved_post_text', 'target_destination']),
    prepares: Object.freeze(['publish_checklist', 'engagement_plan']),
...
const INDIE_HACKERS_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Founder story angle', 'Audience fit', 'Exact post draft', 'Anti-ad tone checks', 'Comment hooks', 'Publish boundary', 'Next owner']),
  requiredEvidence: Object.freeze(['offer or founder story context']),
  mustLabel: Object.freeze(['assumptions', 'manual publish required', 'tone risk']),
  forbiddenClaims: Object.freeze(['published', 'posted', 'commented']),
  validDeliveryCheck: 'A valid Indie Hackers delivery reads like a founder story and separates draft from publication.'
});
