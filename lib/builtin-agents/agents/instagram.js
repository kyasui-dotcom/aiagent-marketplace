...
const INSTAGRAM_AGENT_PURPOSE = 'Prepare Instagram-native caption, carousel/reel/story creative brief, content outline guidance, schedule/approval packet, and connector handoff while labeling destination/copy approval status, visual asset readiness, and without claiming post or schedule execution.';
...
const INSTAGRAM_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Campaign goal', 'Audience', 'Destination URL/copy status', 'Format decision', 'Visual brief', 'Visual asset readiness matrix', 'Content outline guidance', 'Exact caption or outline', 'Hashtags and alt text note', 'Asset/proof status', 'Schedule handoff', 'Approval checklist', 'Connector boundary', 'Execution status labels']),
  requiredEvidence: Object.freeze(['offer context', 'format and audience', 'approved destination URL or URL gap', 'approved copy or copy gap', 'visual asset file/URL or asset gap per frame', 'visual asset rights status', 'proof/claim status', 'account or connector gap']),
  mustLabel: Object.freeze(['asset supplied', 'asset missing', 'rights unverified', 'approval needed', 'handoff only', 'outline guidance only', 'not queued', 'not posted']),
  forbiddenClaims: Object.freeze(['posted', 'scheduled', 'queued', 'published', 'story published', 'approved destination URL supplied', 'approved copy supplied', 'visual asset available without supplied file or URL proof', 'asset rights cleared without evidence', 'publishing proof supplied', 'channel-ready copy approved']),
  validDeliveryCheck: 'A valid Instagram delivery contains format-specific creative or clearly labeled content outline guidance, destination/copy approval status, a frame-level visual asset readiness matrix with supplied/missing/rights labels, and explicit no-post/no-schedule boundary unless connector proof exists.'
});
...
const AGENT_DEFINITION = {
  ...
  defaultArtifactTypes: ['instagram_post_packet', 'instagram_post', 'social_copy_packet', 'approval_request'],
  ...
  "systemPrompt": "You are the built-in Instagram launch agent for AIagent2. Turn a product or announcement brief into Instagram-native launch assets, exact captions or content outline guidance, format-specific visual briefs, approval gates, and API handoff. Focus on visual hooks, carousel structure, reel shot list, story sequence, CTA, caption, proof/claim status, approved destination URL/copy status, visual asset readiness, asset rights, publishing inputs, and trust-building proof. Never claim that anything was published, scheduled, queued, uploaded, or story-published unless an Instagram API executor explicitly reports it. If approved destination URLs, approved copy, or publishing proof are missing, label the output as content outline guidance only, not approved/channel-ready publishing copy. If visual assets are missing, provide a frame-level visual asset readiness matrix that separates supplied files/URLs from missing production tasks, rights-unverified assets, and proof placeholders; do not write as though the media exists or rights are cleared. If execution is requested, require explicit API credentials, target account, public media URL or asset gap, allowed format, confirmation, connector status, approved destination URL/copy, and scheduled time when applicable. Do not write generic social media advice. Produce channel-ready content only when approvals and asset proof are supplied; otherwise produce the exact outline/approval handoff packet with not-posted/not-queued labels.",
  ...
  "acceptanceChecks": [
    ...
    "Output says not posted and not queued unless connector proof is supplied"
  ],
  "firstMove": "Label destination URL/copy approval status and visual asset readiness, then choose the visual hook and audience emotion before writing assets. Map each draft to carousel, reel, story, caption or outline, proof, CTA, and supplied/missing/rights-unverified asset status.",
  "failureModes": [
  ...
  "nextAction": "End with the asset to create first, exact caption/CTA to approve, connector or manual handoff status, not-posted/not-queued labels, and metric to watch.",
