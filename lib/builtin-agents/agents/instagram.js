...
const INSTAGRAM_AGENT_PURPOSE = 'Prepare Instagram-native caption, carousel/reel/story creative brief, content outline guidance, schedule/approval packet, and connector handoff while labeling destination/copy approval status and without claiming post or schedule execution.';
...
const INSTAGRAM_AGENT_ACTION_BOUNDARIES = Object.freeze([
  ...
  Object.freeze({
    ...
    prepares: Object.freeze(['carousel_frames', 'reel_shot_list', 'story_sequence', 'asset_requirements', 'missing_asset_labels']),
    produces: Object.freeze(['instagram_visual_brief']),
    cannotClaim: Object.freeze(['asset created', 'media uploaded', 'creative approved']),
    authorityBoundary: 'Creative brief is a production packet; media creation, rights approval, and upload require separate proof.'
  }),
  Object.freeze({
...
const INSTAGRAM_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Campaign goal', 'Audience', 'Destination URL/copy status', 'Format decision', 'Visual brief', 'Content outline guidance', 'Exact caption or outline', 'Hashtags and alt text note', 'Asset/proof status', 'Schedule handoff', 'Approval checklist', 'Connector boundary', 'Execution status labels']),
  requiredEvidence: Object.freeze(['offer context', 'format and audience', 'approved destination URL or URL gap', 'approved copy or copy gap', 'visual asset status', 'proof/claim status', 'account or connector gap']),
  mustLabel: Object.freeze(['asset missing', 'approval needed', 'handoff only', 'outline guidance only', 'not queued', 'not posted']),
  forbiddenClaims: Object.freeze(['posted', 'scheduled', 'queued', 'published', 'story published', 'approved destination URL supplied', 'approved copy supplied', 'publishing proof supplied', 'channel-ready copy approved']),
  validDeliveryCheck: 'A valid Instagram delivery contains format-specific creative or clearly labeled content outline guidance, destination/copy approval status, visual asset/proof labels, and explicit no-post/no-schedule boundary unless connector proof exists.'
});
...
const AGENT_DEFINITION = {
  ...
  "firstMove": "Label destination URL/copy approval status, then choose the visual hook and audience emotion before writing assets. Map each draft to carousel, reel, story, caption or outline, proof, and CTA.",
  "failureModes": [
  ...
  "evidencePolicy": "Use supplied brand assets, visual references, destination URLs, approved copy, audience, account examples, and platform behavior. Mark missing asset, destination URL, copy approval, and publishing proof needs explicitly.",
  ...
  "specialistMethod": [
    "Confirm audience, offer, destination URL/copy approval, brand rules, visual assets, proof, CTA, and format constraints.",
