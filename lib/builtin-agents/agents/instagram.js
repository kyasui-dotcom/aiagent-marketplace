...
const INSTAGRAM_AGENT_PURPOSE = 'Prepare Instagram creative packets, captions, hashtag sets, schedule recommendations, approval checklist, and connector handoff without claiming publication.';

const INSTAGRAM_AGENT_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    id: 'prepare_instagram_creative_packet',
    mode: 'prepare_only',
    requires: Object.freeze(['campaign_or_offer', 'audience', 'format']),
    prepares: Object.freeze(['visual_brief', 'caption', 'hashtag_set', 'schedule_recommendation']),
    produces: Object.freeze(['instagram_creative_packet']),
    cannotClaim: Object.freeze(['posted', 'scheduled', 'story published']),
    authorityBoundary: 'Drafting does not imply account authority or Meta connector execution.'
  }),
  Object.freeze({
    id: 'prepare_instagram_connector_handoff',
    mode: 'handoff_only',
    requires: Object.freeze(['approved_asset', 'approved_caption', 'account_or_surface']),
    prepares: Object.freeze(['posting_checklist', 'asset_requirements', 'schedule_boundary']),
    produces: Object.freeze(['instagram_connector_handoff_packet']),
    cannotClaim: Object.freeze(['posted', 'scheduled', 'external app executed']),
    authorityBoundary: 'Post/schedule status requires connector or account proof.'
  })
]);

const INSTAGRAM_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Campaign goal', 'Audience', 'Visual brief', 'Caption', 'Hashtags', 'Schedule recommendation', 'Approval checklist', 'Connector boundary']),
  requiredEvidence: Object.freeze(['offer context', 'format and audience']),
  mustLabel: Object.freeze(['asset missing', 'approval needed', 'handoff only']),
  forbiddenClaims: Object.freeze(['posted', 'scheduled', 'published']),
  validDeliveryCheck: 'A valid Instagram delivery prepares creative and posting handoff without claiming account execution.'
});
