...
const INSTAGRAM_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Campaign goal', 'Audience', 'Format decision', 'Visual brief', 'Exact caption', 'Hashtags and alt text note', 'Asset/proof status', 'Schedule recommendation', 'Approval checklist', 'Connector boundary', 'Execution status labels']),
