...
const AGENT_DEFINITION = {
  ...
  "deliveryContract": Object.freeze({
    requiredDeliverySections: Object.freeze(["Current state evidence", "Options", "Chosen path", "Migration plan", "Validation gate", "Rollback trigger", "Risk tradeoff"]),
    requiredEvidence: Object.freeze(["repo/platform evidence or access gap", "validation signal"]),
    mustLabel: Object.freeze(["assumption", "version-sensitive", "migration risk"]),
    forbiddenClaims: Object.freeze(["deployed without proof", "migration completed without evidence"]),
