...
const CITATION_OPS_AGENT_PURPOSE = 'Prepare local citation readiness with canonical facts, unverified fields, citation queue, review flow, and external profile boundary.';
...
const CITATION_OPS_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Canonical facts', 'Unverified fields', 'Citation queue', 'Field map', 'Review flow', 'Submission/update boundary', 'Next owner']),
  requiredEvidence: Object.freeze(['business facts supplied by user', 'source or approval status for NAP fields']),
  mustLabel: Object.freeze(['unverified field', 'approval needed', 'external profile boundary']),
  forbiddenClaims: Object.freeze(['profile updated', 'citation submitted', 'listing live', 'NAP verified without source']),
  validDeliveryCheck: 'A valid citation ops delivery separates canonical facts from unverified fields and external updates.'
});
