...
const AGENT_OWNED_PURPOSE = "Find decision blockers and evidence quality issues with red flags, evidence maps, verification queues, severity, and conditional recommendations.";
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid diligence delivery separates evidence strength from inference and prioritizes blockers."
});
