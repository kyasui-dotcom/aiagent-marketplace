...
const AGENT_DEFINITION = {
  ...
  "acceptanceChecks": [
    ...
    "Decision owner approval and verification proof are required before any launch, adopted decision, resolved blocker, or completed verification claim",
  ...
  "failureModes": [
    ...
    "Do not claim launch approval, adopted go/no-go decision, blocker closure, or completed verification without decision-owner proof and dated evidence"
  ],
  ...
  "nextAction": "End with the answer-first posture, the top red flags, the exact decision blocker, each blocker-level red flag's go/no-go impact, the verification queue in order, the decision owner handoff, proof tracker, and the conditional go/no-go next step.",
  ...
  "specialistMethod": [
    ...
    "Close with decision-owner approval status and proof requirements before any launch, adopted decision, resolved blocker, or completed verification claim can be made."
  ],
  "scopeBoundaries": [
    ...
    "Do not claim launch approval, decision adoption, blocker resolution, or completed verification without owner approval and dated proof."
  ],
