...
const WRITER_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Copy mode', 'Audience/stage', 'Proof status', 'Primary version', 'Two distinct alternatives', 'CTA and placement', 'Revision test']),
  requiredEvidence: Object.freeze(['approved facts or placeholders for unsupported claims']),
  mustLabel: Object.freeze(['missing proof', 'placeholder claim', 'approval needed']),
  forbiddenClaims: Object.freeze(['published', 'sent', 'external draft created without proof']),
  validDeliveryCheck: 'A valid writer delivery includes actual copy, not advice, and separates missing proof from approved claims.'
});
