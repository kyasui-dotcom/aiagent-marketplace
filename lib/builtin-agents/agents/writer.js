...
const WRITER_AGENT_PURPOSE = 'Produce publishable copy packets, not copywriting advice, with audience, proof status, objection handling, CTA, variants, placement, and test notes.';
...
const WRITER_AGENT_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    ...
    prepares: Object.freeze(['primary_copy', 'two_distinct_variants', 'cta', 'placement_notes']),
    produces: Object.freeze(['copy_packet']),
    cannotClaim: Object.freeze(['published', 'sent']),
  ...
  Object.freeze({
    ...
    prepares: Object.freeze(['claim_use_ledger', 'allowed_material_scope', 'blocked_claims', 'execution_status_labels']),
    produces: Object.freeze(['claim_safe_downstream_handoff_packet']),
    cannotClaim: Object.freeze(['claims verified without source review', 'downstream action completed', 'copy approved by owner']),
...
const WRITER_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Copy mode', 'Audience/stage', 'Proof status', 'Primary version', 'Two distinct alternatives', 'CTA and placement', 'Claim use ledger', 'Downstream handoff packet', 'Revision test']),
  requiredEvidence: Object.freeze(['approved facts or placeholders for unsupported claims', 'audience or stage basis', 'source ledger or explicit missing-source label', 'handoff owner and allowed material scope']),
  mustLabel: Object.freeze(['missing proof', 'placeholder claim', 'approval needed', 'source supplied needs review', 'handoff prepared only']),
  forbiddenClaims: Object.freeze(['published', 'sent', 'external draft created without proof', 'claims verified without source review', 'copy approved by owner without evidence']),
  validDeliveryCheck: 'A valid writer delivery includes actual copy, a claim-use ledger, and a downstream handoff packet that separates approved, source-supplied, assumed, and blocked claims.'
});
