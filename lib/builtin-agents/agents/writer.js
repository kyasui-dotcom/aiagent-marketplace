const AGENT_PROVIDER = Object.freeze({
  ...
  async runJob({ kind = '', definition = {}, body = {}, source = {} } = {}) {
    ...
    if (!markdown && !publisherHandoffs.length) return agentProviderDeliveryFailure(kind, definition, name, japanese, 'missing_required_deliverable: original request, source context, or concrete artifact was not available.');
    return {
      accepted: true,
      status: 'completed',
      summary: japanese
