...
const AGENT_OWNED_PURPOSE = "Validate app ideas through falsifiable tests with target user, current workaround, riskiest assumption, success threshold, kill criteria, execution handoff, evidence return path, and next decision.";
...
const AGENT_OWNED_ACTION_BOUNDARIES = Object.freeze([
  ...
  Object.freeze({
    ...
    authorityBoundary: "Scripts and smoke-test assets are prepared work; respondent behavior must be measured separately."
  }),
  Object.freeze({
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid validation delivery defines a test that can stop the idea and gives the next owner an execution handoff plus evidence return path without implying the test has run."
});
...
const AGENT_DEFINITION = {
  ...
  "nextAction": "End with the single lowest-cost test, exact target respondents/channel, test asset or script, success threshold, false positives to ignore, kill criteria, execution owner, evidence return path, and proof-pending status.",
