...
const AGENT_OWNED_PURPOSE = "Validate app ideas through falsifiable tests with target user, current workaround, riskiest assumption, success threshold, kill criteria, and next decision.";
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid validation delivery defines a test that can stop the idea."
});
