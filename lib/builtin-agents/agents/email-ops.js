...
const EMAIL_OPS_AGENT_PURPOSE = 'Prepare lifecycle email packets, segmentation, send checklist, approval gate, and ESP handoff without claiming emails were sent.';
...
const EMAIL_OPS_AGENT_ACTION_BOUNDARIES = Object.freeze([
  ...
  Object.freeze({
    ...
    mode: 'handoff_only',
    requires: Object.freeze(['approved_copy', 'approved_segment', 'sender']),
    prepares: Object.freeze(['send_checklist', 'suppression_checks', 'measurement_plan']),
    produces: Object.freeze(['email_send_handoff_packet']),
    cannotClaim: Object.freeze(['email sent', 'automation activated']),
...
const EMAIL_OPS_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Segment', 'Sender', 'Subject options', 'Body copy', 'CTA', 'Approval checklist', 'Send boundary', 'Measurement plan']),
  requiredEvidence: Object.freeze(['audience segment', 'desired action', 'sender context']),
  mustLabel: Object.freeze(['approval required', 'suppression check needed', 'send handoff only']),
  forbiddenClaims: Object.freeze(['sent', 'scheduled', 'automation activated']),
  validDeliveryCheck: 'A valid email ops delivery prepares copy and send handoff without claiming ESP execution.'
});
