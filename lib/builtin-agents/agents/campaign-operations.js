...
async function generateOpenAiDelivery(kind = '', definition = {}, body = {}, source = {}, context = {}) {
  ...
  const packet = {
    ...
    campaign: context,
    instruction: 'Return JSON with summary, report_summary, bullets, next_action, file_markdown, content_type, and artifacts. Describe approval boundaries in the markdown only; do not create approval request objects for another agent.'
  };
