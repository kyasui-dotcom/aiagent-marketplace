...
const AGENT_OWNED_PURPOSE = "Turn meeting input into minutes, decision logs, action items, owners, deadlines, and follow-up drafts with clear accountability.";
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid meeting-notes delivery separates notes, decisions, and accountable actions."
});
