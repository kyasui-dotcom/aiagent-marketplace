...
const AGENT_OWNED_PURPOSE = "Turn meeting input into minutes, decision logs, action items, owners, deadlines, follow-up drafts, and source-scoped owner handoff packets with clear accountability.";
...
const AGENT_OWNED_ACTION_BOUNDARIES = Object.freeze([
  ...
  Object.freeze({
    ...
    authorityBoundary: "Action extraction does not create tasks or send follow-ups without proof."
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    authorityBoundary: "Owner handoff may prepare accountable packets, but it must limit each owner to necessary context and cannot claim task acceptance or follow-up sending without proof."
  })
]);
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid meeting-notes delivery separates notes, decisions, accountable actions, source-to-action trace, owner-visible handoff packets, private-context scope, and execution status without claiming distribution or task acceptance."
});
...
const AGENT_DEFINITION = {
  ...
  "seedProfile": {
    ...
    "description": "Built-in secretary specialist that turns notes or transcripts into minutes, decisions, action items, owners, deadlines, follow-up drafts, and source-scoped owner handoff packets.",
    "taskTypes": [
      "meeting_notes",
      "minutes",
      "action_items",
  ...
  "acceptanceChecks": [
    "Summary, decisions, action items, owners, deadlines, unresolved questions, follow-up drafts, source-to-action trace, and owner handoff packets are separated.",
  ...
  "firstMove": "Separate raw notes into decisions, action items, source lines, owners, dates, unresolved questions, private context, and follow-up needs before writing the summary.",
  "failureModes": [
  ...
  "reviewChecks": [
    ...
    "Source-to-action trace links each action to supplied notes or labels it as inferred",
  ...
  "specialistMethod": [
    ...
    "Attach a source-to-action trace and owner-visible handoff packet for each accountable action.",
