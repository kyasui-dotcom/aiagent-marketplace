...
const LAUNCH_TEAM_AGENT_PURPOSE = 'Lead product launch preparation by turning a feature or offer into launch sequence, asset queue, approval gates, and measurement without claiming public launch execution.';

const LAUNCH_TEAM_AGENT_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    id: 'prepare_launch_plan',
    mode: 'leader_strategy',
    requires: Object.freeze(['launch_subject', 'audience', 'desired_action', 'timing']),
    prepares: Object.freeze(['launch_sequence', 'asset_map', 'risk_register']),
    produces: Object.freeze(['launch_plan_packet']),
    cannotClaim: Object.freeze(['launched', 'published', 'emailed', 'posted']),
    authorityBoundary: 'Launch plan approval and channel-specific execution remain outside this leader.'
  }),
  Object.freeze({
    id: 'prepare_launch_handoff_queue',
    mode: 'leader_to_specialist_handoff',
    requires: Object.freeze(['approved_launch_sequence', 'channel_or_surface']),
    prepares: Object.freeze(['copy_tasks', 'publisher_tasks', 'social_tasks', 'measurement_tasks']),
    produces: Object.freeze(['launch_handoff_queue_packet']),
    cannotClaim: Object.freeze(['asset created by specialist', 'Publisher item created without proof']),
    authorityBoundary: 'Each channel owner must return its own artifact or execution proof.'
  })
]);

const LAUNCH_TEAM_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze(['Launch objective', 'Audience and offer', 'Launch sequence', 'Asset queue', 'Approval gates', 'Risk controls', 'Measurement plan', 'Next owner']),
  requiredEvidence: Object.freeze(['feature or offer description', 'desired action', 'timing constraint']),
  mustLabel: Object.freeze(['assumptions', 'approval gates', 'handoff-only tasks']),
  forbiddenClaims: Object.freeze(['launched', 'published', 'sent', 'posted', 'external app executed']),
  validDeliveryCheck: 'A valid launch team delivery separates launch leadership from channel execution and proof.'
});

const AGENT_DEFINITION = {
  provider: AGENT_PROVIDER,
  agentPurpose: LAUNCH_TEAM_AGENT_PURPOSE,
  agentActionBoundaries: LAUNCH_TEAM_AGENT_ACTION_BOUNDARIES,
  deliveryContract: LAUNCH_TEAM_DELIVERY_CONTRACT,
