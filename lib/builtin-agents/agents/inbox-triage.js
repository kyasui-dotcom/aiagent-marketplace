...
const AGENT_OWNED_PURPOSE = "Triage inbox items into owner-ready queues with snapshot freshness, message source, priority reason, reply-needed status, owner, deadline, risk flag, privacy-minimized specialist handoff, approval packet, and confidence.";
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid inbox delivery routes each visible item to an owner, deadline/timing status, next action, connector state, privacy scope, approval packet, and downstream specialist handoff without claiming mailbox mutation or fresh state beyond the dated snapshot."
});
...
const AGENT_DEFINITION = {
  ...
  "acceptanceChecks": [
    ...
    "Each routed item preserves snapshot freshness, message/thread source, deadline or timing status, and connector state.",
  ...
  "evidencePolicy": "Use only supplied or connected inbox/message context, and label the snapshot date/time or staleness. If context is missing, return the exact Gmail label, search, date range, or export needed.",
  ...
  "specialistMethod": [
    ...
    "Label the snapshot time or stale/unknown state before making priority calls.",
