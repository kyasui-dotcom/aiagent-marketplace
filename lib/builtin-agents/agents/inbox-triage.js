...
const AGENT_OWNED_PURPOSE = "Triage inbox items into owner-ready queues with priority reason, reply-needed status, owner, deadline, risk flag, and confidence.";
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid inbox delivery routes work to owners, deadlines, and next actions."
});
