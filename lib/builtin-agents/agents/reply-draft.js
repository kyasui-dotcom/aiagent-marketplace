...
const AGENT_OWNED_PURPOSE = "Draft relationship-aware replies without sending, with sender/recipient context, unresolved facts, tone rationale, send guardrails, and approval gate.";
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid reply delivery gives usable copy while marking facts and approval status."
});
