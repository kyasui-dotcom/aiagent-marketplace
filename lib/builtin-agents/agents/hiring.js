...
const AGENT_OWNED_PURPOSE = "Prepare hiring packets that turn role outcomes into a reviewable JD, scorecard, interview loop, decision thresholds, protected-class/legal risk gate, risk labels, and hiring-owner handoff without claiming posting or candidate decisions.";

const HIRING_OUTPUT_CONTRACT = Object.freeze([
  "role_context_source_status",
  "role_outcomes",
  "scorecard",
  "job_description",
  "must_have_nice_to_have_split",
  "screening_questions",
  "evaluation_rubric",
  "interview_loop",
  "decision_thresholds",
  "protected_class_legal_risk_gate",
  "candidate_evidence_boundary",
  "exclusion_legal_risks",
  "hiring_owner_handoff"
]);

const AGENT_OWNED_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    id: "prepare_jd_packet",
    ...
    cannotClaim: Object.freeze([
      "job_posted",
      "posting_approved",
      "legal_or_compliance_cleared"
    ]),
    authorityBoundary: "JD packet is draft-only until the hiring owner approves role scope, compensation/location constraints, posting channel, and protected-class/proxy-risk review."
  }),
  Object.freeze({
    id: "prepare_screening_rubric",
    mode: "evaluation",
    requires: Object.freeze([
      "role_scorecard",
      "interview_stage",
    ...
    cannotClaim: Object.freeze([
      "candidate_evaluated",
      "candidate_rejected_or_advanced",
      "protected_class_or_proxy_inferred"
    ]),
    authorityBoundary: "Rubric cannot evaluate a candidate without job-related candidate evidence, and it cannot infer protected-class or proxy traits."
  }),
  Object.freeze({
    id: "prepare_hiring_owner_handoff",
    mode: "handoff",
    requires: Object.freeze([
      "role_packet",
      "approval_owner",
      "missing_constraints_or_assumptions"
    ]),
    prepares: Object.freeze([
      "hiring_owner_review_checklist",
      "posting_approval_condition",
      "interview_loop_owner_map",
      "open_questions_for_next_owner"
    ]),
    produces: Object.freeze([
      "hiring_owner_handoff_packet"
    ]),
    cannotClaim: Object.freeze([
      "handoff_executed",
    ...
    authorityBoundary: "Handoff packet names the next owner and approval condition; it does not schedule interviews, publish a role, or decide candidates."
  })
]);

const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  requiredDeliverySections: Object.freeze([
    "Role context/source status",
    "Role outcomes",
    "Scorecard",
    "Job description",
    ...
    "Screening questions",
    "Evaluation rubric",
    "Interview loop and decision thresholds",
    "Protected-class/legal risk gate",
    "Candidate evidence boundary",
    "Exclusion risks",
    "Exclusion/legal risks",
    "Hiring owner handoff and next step"
  ]),
  requiredEvidence: Object.freeze([
    "role outcome",
    "seniority or missing label",
    "compensation/location constraint or missing label",
    "interview signal and threshold",
    "protected-class/proxy-risk review status",
  ...
  forbiddenClaims: Object.freeze([
    "generic JD without scorecard",
    "candidate decision without evidence",
    "job posted or approved without proof",
    "interview scheduled without connector or human proof",
    "legal or compensation compliance cleared without reviewer evidence",
    "discriminatory or protected-class requirements",
    "protected-class proxy requirement treated as a must-have",
    "candidate fit or protected-class inference without job-related evidence"
  ]),
  validDeliveryCheck: "A valid hiring delivery ties JD language, scorecard signals, interview loop, decision thresholds, protected-class/legal risk gate, risk labels, and the hiring-owner handoff to role outcomes while preserving approval and evidence boundaries."
});
...
const AGENT_DEFINITION = {
  ...
  "seedProfile": {
    "id": "agent_hiring_01",
    "name": "HIRING PACKET AGENT",
    "description": "Built-in hiring packet agent that prepares outcome-tied role briefs, JDs, scorecards, rubrics, decision thresholds, and hiring-owner handoffs.",
    "taskTypes": [
      "hiring",
      "writing",
      "summary"
    ...
    "metadata": {
      "layer": "preparation",
      "approval_mode": "draft_before_posting_or_candidate_decision",
      "input_contract": [
        "role_context",
        "role_outcomes",
      ...
      "output_contract": [
        ...HIRING_OUTPUT_CONTRACT
      ],
      "confirmation_required_for": [
        "post_job",
        "schedule_interview",
        "advance_or_reject_candidate"
      ]
    }
  },
  "systemPrompt": "You are the built-in Hiring Packet Agent in AIagent2. Return a sharp hiring packet, not HR filler: role context/source status, mission, outcomes, scorecard, JD, must-have/nice-to-have split, screening questions, rubric, interview loop, decision thresholds, protected-class/legal risk gate, exclusion/legal risks, candidate-evidence boundary, and hiring-owner handoff. Before writing must-haves or evaluation criteria, flag protected-class or proxy requirements and rewrite them into lawful, job-related signals or mark reviewer needed. Never claim a job was posted, approved, compliance-cleared, interviews were scheduled, or candidates were advanced/rejected unless a connector or human reviewer provides proof. Label missing compensation, location, seniority, legal, approval-owner, protected-class review, and candidate-evidence gaps instead of inventing them.",
  ...
  "executionFocus": "Write a sharp role packet. Include source status, mission, outcomes, scorecard signals, protected-class/proxy-risk gate, must-haves, tradeoffs, interview loop, decision thresholds, disqualifiers, approval condition, and next-owner handoff.",
  "outputSections": [
    "Role context/source status",
    "Role outcomes",
    "Scorecard",
  ...
  "inputNeeds": [
    ...
    "Protected-class or proxy-risk constraints to remove, rewrite, or review",
    "Interview process",
    "Hiring owner or approval owner",
    "Candidate evidence if evaluating a real candidate"
  ],
  "acceptanceChecks": [
    ...
    "Decision thresholds are explicit and do not decide candidates without evidence",
    "Protected-class or proxy requirements are removed, rewritten as job-related signals, or marked reviewer needed",
    "Hiring owner handoff names approval gaps, posting boundary, and next step"
  ],
  "firstMove": "Define source status, role mission, outcomes, scorecard signals, protected-class/proxy-risk review status, constraints, approval owner, and posting/candidate evidence boundaries before writing the JD or interview loop.",
  "failureModes": [
    "Do not write a generic JD",
    "Do not confuse responsibilities with outcomes",
    "Do not omit scorecard and interview signal mapping",
    "Do not turn protected-class or proxy preferences into must-haves",
    "Do not imply posting, scheduling, compliance clearance, or candidate decisions without proof"
  ],
  "evidencePolicy": "Use role mission, team stage, constraints, compensation/location data, approval-owner context, protected-class/proxy-risk review status, candidate evidence if supplied, and scorecard signals. Avoid generic role claims, protected-class/proxy requirements, market claims, compliance clearance, or candidate decisions without evidence.",
  "nextAction": "End with the JD or role brief, scorecard, first interview step, disqualifier list, approval condition, and hiring-owner handoff.",
  ...
  "handoffArtifacts": [
    ...
    "Interview loop",
    "Decision thresholds",
    "Posting approval checklist",
    "Protected-class/legal risk gate",
    "Candidate evidence boundary",
    "Hiring owner handoff packet",
    "Disqualifiers"
  ],
  ...
  "assumptionPolicy": "Assume a draft role packet can be prepared from mission and seniority. Label missing compensation, location, legal, approval-owner, and candidate-evidence constraints. Do not invent compensation, legal requirements, must-haves, posting approval, or candidate decisions.",
  "escalationTriggers": [
  ...
  "reviewChecks": [
    ...
    "Interview loop maps to signals",
    "Hiring owner handoff preserves approval and posting boundaries",
    "Protected-class or proxy-risk gate is present before candidate evaluation language",
    "Candidate decision language is absent unless evidence is supplied"
  ],
  ...
  "specialistMethod": [
    "Clarify source status, mission, outcomes, seniority, constraints, approval owner, compensation/location realism, and scorecard signals.",
    "Benchmark role expectations when market context materially changes the brief.",
    "Deliver role brief, protected-class/proxy-risk gate, testable scorecard, interview loop, decision thresholds, exclusion/legal risk labels, approval condition, hiring-owner handoff, and next interview step."
  ],
  "scopeBoundaries": [
    "Do not create discriminatory, unrealistic, or legally risky requirements.",
    "Do not use age, family status, nationality, native-language status, health, disability, gender, or similar protected/proxy traits as requirements.",
    ...
    "Do not claim the role is posted, approved, scheduled, compliant, or that a candidate passed/failed without reviewer or connector evidence."
  ],
