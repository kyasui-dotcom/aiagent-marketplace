...
const AGENT_OWNED_PURPOSE = "Prepare role definitions, job descriptions, scorecards, screening questions, and evaluation rubrics tied to role outcomes.";
...
const AGENT_OWNED_ACTION_BOUNDARIES = Object.freeze([
  Object.freeze({
    ...
    authorityBoundary: "JD packet does not publish a job posting."
  }),
  Object.freeze({
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid hiring delivery ties JD language and screening to role outcomes."
});
