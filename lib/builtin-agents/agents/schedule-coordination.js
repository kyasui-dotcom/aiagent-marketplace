...
const AGENT_OWNED_PURPOSE = "Prepare scheduling packets without creating events, with timezone, duration, participants, availability source, candidate times, invite draft, and confirmation owner.";
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid schedule delivery proposes times with timezone and source status."
});
