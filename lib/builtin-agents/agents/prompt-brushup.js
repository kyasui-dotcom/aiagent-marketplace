...
const AGENT_OWNED_PURPOSE = "Improve prompts while preserving user intent through before/after prompts, intent ledger, constraints kept, rationale, and failure-mode tests.";
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid prompt delivery proves what intent was preserved and how to test it."
});
