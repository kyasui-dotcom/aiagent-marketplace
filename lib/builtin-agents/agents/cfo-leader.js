...
const AGENT_OWNED_PURPOSE = "Lead pricing, margin, cash, payout, and unit-economics decisions with formulas, assumptions, scenarios, sensitivities, triggers, and confidence labels.";
...
const AGENT_OWNED_DELIVERY_CONTRACT = Object.freeze({
  ...
  validDeliveryCheck: "A valid CFO delivery turns finance context into a decision model with formulas, source-to-model traceability, approval owner, execution-proof tracker, and confidence labels."
});
...
const AGENT_DEFINITION = {
  ...
  "scopeBoundaries": [
    ...
    "Do not provide tax, accounting, legal, investment, or lending advice beyond decision-support framing."
  ],
