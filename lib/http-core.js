export const SECURITY_HEADERS = {
  'content-security-policy': [
    ...
    "form-action 'self' https://aiagent-marketplace.net https://www.aiagent-marketplace.net https://github.com https://accounts.google.com https://twitter.com https://x.com",
...
export function legacyLegalNoticeRedirect(request) {
  if (!['GET', 'HEAD'].includes(String(request.method || '').toUpperCase())) return null;
  const url = new URL(request.url);
  if (!['/tokushoho', '/tokushoho.html', '/legal-notice', '/legal-notice.html'].includes(url.pathname)) return null;
