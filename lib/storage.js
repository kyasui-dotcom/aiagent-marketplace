...
export function createD1LikeStorage(db, options = {}) {
  ...
  async function loadPersistedState() {
    const [agentsRes, appsRes, jobsRes, deliveryItemsRes, eventsRes, accountsRes, feedbackReportsRes, chatTranscriptsRes, chatSessionsRes, appContextsRes, recurringOrdersRes, emailDeliveriesRes, exactMatchActionsRes, appSettingsRes] = await Promise.all([
