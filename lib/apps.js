...
export const DEFAULT_APP_SEEDS = Object.freeze([
  ...
  },
  {
    ...
    kind: 'application_agent',
    description: 'Growth experiment console that retains bottleneck, ICP/offer, hypothesis, exact artifact packet, owner map, measurement surface, threshold, kill rule, proof source, review date, next decision, and status labels before launch.',
    baseUrl: DEFAULT_CAIt_APP_BASE_URL,
    ...
    metadata: {
      ...
      manifest: {
        ...
        kind: 'application_agent',
        name: 'Growth Experiment Console',
        description: 'Growth experiment console that preserves experiment, artifact, activation, measurement surface, proof source, next decision, and kill-rule state before launch.',
