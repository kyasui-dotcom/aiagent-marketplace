...
assert.ok(chatHtml.includes('/chat.css?v=20260526d'), 'Chat page should load the current intake-composer hint styles.');
assert.ok(chatHtml.includes('/chat.js?v=20260526n'), 'Chat page should load the current intake-composer controller.');
assert.ok(chatHtml.includes('id="composerModeHint"'), 'Chat composer should show a visible mode hint near the answer box.');
assert.ok(chatJs.includes("chatText('Send answer', '回答を送信'"), 'Chat intake mode should rename the submit button from generic chat sending to answer sending.');
