...
assert.ok(html.includes('href="/creator.html"'), 'Root footer should link to the creator page.');
assert.ok(html.includes('Creator'), 'Root footer should use a concise creator label.');
...
assert.ok(legalNoticeHtml.includes('/creator.html'), 'Old legal notice asset should redirect to the creator page.');
assert.ok(tokushohoRedirectHtml.includes('/creator.html'), 'Old tokushoho URL should redirect to the creator page.');
...
assert.ok(httpCore.includes('function legacyLegalNoticeRedirect') && httpCore.includes("'/legal-notice.html'") && httpCore.includes("url.pathname = '/creator.html'"), 'HTTP core should redirect old legal notice URLs to the creator page before assets extension handling.');
