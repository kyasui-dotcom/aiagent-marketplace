...
const expectedOutputContracts = new Map([
  ...
  ['agent_validation_01', ['target_user', 'current_workaround', 'riskiest_assumption', 'test_design', 'test_script_or_asset', 'success_threshold', 'kill_criteria', 'false_positives_to_ignore', 'execution_handoff_packet', 'evidence_return_path', 'execution_status_labels', 'next_decision']],
  ...
  ['agent_diligence_01', ['decision_context', 'evidence_map', 'red_flag_matrix', 'fact_vs_inference', 'verification_queue', 'blocker_severity', 'go/no_go_impact', 'next_verification_per_red_flag', 'conditional_recommendation']],
