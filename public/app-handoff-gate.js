...
const EXPLICIT_HANDOFF_TYPE_ALIASES = {
  ...
  lead_acquisition_request: ['lead_rows', 'evidence_urls', 'next_actions'],
  lead_ops_packet: ['lead_rows', 'evidence_urls', 'email_drafts', 'next_actions', 'outreach_plan'],
  lead_packet: ['lead_rows', 'evidence_urls', 'email_drafts', 'next_actions'],
  outreach_packet: ['lead_rows', 'email_drafts', 'outreach_plan'],
  ...
  ads_plan_packet: ['ads_plan', 'campaign_structure', 'budget_cap_and_cpa_assumption', 'stop_rules', 'creative_asset_packet', 'ads_saas_handoff', 'approval_and_launch_boundary', 'execution_status_labels', 'measurement_plan'],
  paid_ads_plan: ['ads_plan', 'campaign_structure', 'budget_cap_and_cpa_assumption', 'stop_rules', 'creative_asset_packet', 'ads_saas_handoff', 'approval_and_launch_boundary', 'execution_status_labels', 'measurement_plan'],
  ad_plan: ['ads_plan'],
  ad_campaign_plan: ['ads_plan', 'campaign_structure'],
  paid_acquisition_plan: ['ads_plan', 'campaign_structure', 'budget_cap_and_cpa_assumption'],
  approval_ready_ad_asset_packet: ['creative_asset_packet'],
  ad_asset_packet: ['creative_asset_packet'],
  creative_assets: ['creative_asset_packet'],
  ad_creatives: ['creative_asset_packet'],
  ads_saas_fields: ['ads_saas_handoff'],
  ads_handoff: ['ads_saas_handoff'],
  launch_approval_handoff_packet: ['launch_approval_handoff', 'approval_and_launch_boundary'],
  launch_approval_checklist: ['approval_and_launch_boundary', 'launch_approval_handoff'],
  approval_checklist: ['approval_and_launch_boundary'],
  missing_execution_inputs: ['approval_and_launch_boundary'],
  target_cpa_assumptions: ['budget_cap_and_cpa_assumption'],
  ...
  content_package: ['site_publish_packet', 'approval_request'],
  publisher_content_package: ['site_publish_packet', 'approval_request'],
...
const DEFAULT_HANDOFF_ARTIFACT_CAPABILITY_ALIASES = Object.freeze({
  ...
  lead_acquisition_request: Object.freeze(['lead_management', 'crm_packet', 'outreach_review']),
  lead_ops_packet: Object.freeze(['lead_management', 'crm_packet', 'outreach_review']),
  lead_packet: Object.freeze(['lead_management', 'crm_packet', 'outreach_review']),
  outreach_packet: Object.freeze(['lead_management', 'email_draft', 'outreach_review']),
  evidence_urls: Object.freeze(['lead_management', 'crm_packet']),
  outreach_plan: Object.freeze(['lead_management', 'email_draft', 'outreach_review']),
  ...
  ads_plan: Object.freeze(['ads_plan', 'budget_guardrails']),
  ads_plan_packet: Object.freeze(['ads_plan', 'budget_guardrails']),
  paid_ads_plan: Object.freeze(['ads_plan', 'budget_guardrails']),
  campaign_structure: Object.freeze(['ads_plan']),
  budget_cap_and_cpa_assumption: Object.freeze(['budget_guardrails', 'ads_plan']),
  budget_guardrails: Object.freeze(['budget_guardrails', 'ads_plan']),
  stop_rules: Object.freeze(['stop_rules', 'budget_guardrails']),
  creative_asset_packet: Object.freeze(['creative_asset_packet']),
  ads_saas_handoff: Object.freeze(['ads_saas_handoff']),
  ads_saas_handoff_packet: Object.freeze(['ads_saas_handoff']),
  approval_and_launch_boundary: Object.freeze(['launch_approval_handoff']),
...
const DEFAULT_HANDOFF_ARTIFACT_LABELS = Object.freeze({
  ...
  lead_rows: 'Lead rows',
  lead_acquisition_request: 'Lead acquisition request',
  lead_ops_packet: 'Lead Ops packet',
  lead_packet: 'Lead packet',
  outreach_packet: 'Outreach packet',
